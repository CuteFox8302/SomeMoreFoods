package net.cutefox.somemorefoods.block.custom;

import net.cutefox.somemorefoods.block.entity.BoilerBlockEntity;
...
public class BoilerBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.BOILER, BoilerBlockEntity::tick);
    }
}