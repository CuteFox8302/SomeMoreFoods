...
public class ModItems {
    ...
    public static final Item MAPLE_SUGAR = registerItem("maple_sugar",
            new Item(new FabricItemSettings().food(ModFoodComponents.MAPLE_SUGAR).group(ModItemGroup.SOME_MORE_FOODS)));
    ...
    public static final Item CHOCOLATE_CHIP_WAFFLE_WITH_SYRUP = registerItem("chocolate_chip_waffle_with_syrup",
            new Item(new FabricItemSettings().food(ModFoodComponents.CHOCOLATE_CHIP_WAFFLE_WITH_SYRUP).group(ModItemGroup.SOME_MORE_FOODS)));
    public static final Item FROZEN_CHOCOLATE_CHIP_WAFFLE_WITH_SYRUP = registerItem("frozen_chocolate_chip_waffle_with_syrup",
            new Item(new FabricItemSettings().food(ModFoodComponents.FROZEN_CHOCOLATE_CHIP_WAFFLE_WITH_SYRUP).group(ModItemGroup.SOME_MORE_FOODS)));
